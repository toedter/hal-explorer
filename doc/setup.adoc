...
in a Web browser at `/webjars/hal-explorer/1.1.0/index.html`.
...
Of course, you could always download a zip-based https://github.com/toedter/hal-explorer/releases/download/v1.1.0/hal-explorer-1.1.0.zip[distribution] and put it on any Web server.

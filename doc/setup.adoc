...
|===
| Latest Release | 2.0.0 | https://toedter.github.io/hal-explorer/release/hal-explorer/#theme=Cosmo&uri=examples/examples.hal-forms.json[HAL Explorer Demo]
| Current Snapshot | 2.0.1-SNAPSHOT | https://toedter.github.io/hal-explorer/snapshot/hal-explorer/#theme=Cosmo&uri=examples/examples.hal-forms.json[HAL Explorer Demo]
|===
...
.Gradle
----
implementation 'org.webjars:hal-explorer:2.0.0'
----

When you use the WebJar with Spring Boot, you can access HAL Explorer
in a web browser at `/webjars/hal-explorer/2.0.0/index.html`.
...
You can also download a zip-based https://github.com/toedter/hal-explorer/releases/download/v2.0.0/hal-explorer-2.0.0.zip[distribution] and deploy it on any web server.

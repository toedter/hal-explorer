...
|===
| Latest Release | 2.1.0 | https://toedter.github.io/hal-explorer/release/hal-explorer/#theme=Cosmo&uri=examples/examples.hal-forms.json[HAL Explorer Demo]
| Current Snapshot | 2.1.1-SNAPSHOT | https://toedter.github.io/hal-explorer/snapshot/hal-explorer/#theme=Cosmo&uri=examples/examples.hal-forms.json[HAL Explorer Demo]
|===
...
You can also download a zip-based https://github.com/toedter/hal-explorer/releases/download/v2.1.0/hal-explorer-2.1.0.zip[distribution] and deploy it on any web server.

...
The latest released version of HAL Explorer you can find https://toedter.github.io/hal-explorer/release/hal-explorer/[here].
To explore your own services with this HAL Exlorer, they have to enable CORS. When you want to explore a Spring based service, you could add a simple https://gist.github.com/toedter/72d62b4bb4a25d229dc1f1342ae429ad[CORS Filter] to your service.

You can also play around with the latest snapshot version of HAL Explorer in running demos:

...
| Current Snapshot | 2.0.0-SNAPSHOT | https://toedter.github.io/hal-explorer/snapshot/hal-explorer/#theme=Cosmo&uri=examples/examples.hal-forms.json[HAL Explorer Demo]
|===
...
You can also download a zip-based https://github.com/toedter/hal-explorer/releases/download/v1.2.3/hal-explorer-1.2.3.zip[distribution] and deploy it on any web server.

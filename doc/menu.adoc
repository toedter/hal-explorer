...
In the top-level menu you can choose the color mode, theme, settings, and view the 'About' dialog.
...
* Default (HAL Explorers default theme)
...
In the _Settings_ sub menu, you can configure:

...
describe('JsonHighlighterService', () => {
  ...
  it('should highlight boolean', inject([JsonHighlighterService], () => {
  ...
  it('should highlight null', inject([JsonHighlighterService], () => {
  ...
  it('should not highlight undefined input', inject([JsonHighlighterService], () => {
    const output = jsonHighlighterService.syntaxHighlight(undefined);
    expect(output).toBeUndefined();
  }));

  it('should not highlight invalid input', inject([JsonHighlighterService], () => {

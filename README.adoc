...
Gradle:
[source]
compile 'org.webjars:hal-explorer:0.10.0'

When you use the WebJar with Spring Boot, you can access the HAL Explorer at `/webjars/hal-explorer/0.10.0/index.html`.

...
If you run `yarn start:fs`, an additional file server is started with port 3000.
...
* `yarn e2e` to run the e2e test suite against default browsers (using Playwright).

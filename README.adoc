...
HAL Explorer supports both Spring Profiles and HAL-FORMS.
...
When you use the WebJar with Spring Boot, you can access the HAL Explorer at `/webjars/hal-explorer/0.12.0/index.html`.

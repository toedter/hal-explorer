image:https://travis-ci.com/toedter/hal-explorer.svg?branch=master[Build Status, link="https://travis-ci.com/toedter/hal-explorer"]
...
* Support for HAL-FORMS (_templates) to populate properties in request editor
  and to provide only supported HTTP methods for self/target link

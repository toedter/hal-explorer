...
|===
| Release | 0.16.0 | https://toedter.github.io/hal-explorer/release/reference-doc/[Reference Documentation] | https://toedter.github.io/hal-explorer/release/hal-explorer[HAL Explorer Demo]
| Snapshot | 0.17.0-SNAPSHOT | https://toedter.github.io/hal-explorer/snapshot/reference-doc/[Reference Documentation] | https://toedter.github.io/hal-explorer/snapshot/hal-explorer/#theme=Cosmo&uri=https://raw.githubusercontent.com/toedter/hal-explorer/master/test-data/examples.hal-forms.json[HAL Explorer Demo]
|===
